...
class AnomalyDetector:
    """
    Detects anomalies in data using statistical methods (IQR, Z-score)
    ...
    def check_rule(self, column: str, rule_func, rule_name: str) -> List[int]:
        """
        Apply a custom rule function to a column.
        rule_func should return True for valid data, False for anomaly.
        """
        if column not in self.df.columns:
            return []
