...
# -------------------------------------------------------------------
# Make sure Python can import from: data-pipeline/dags/src
# -------------------------------------------------------------------
THIS_FILE = Path(__file__).resolve()
PROJECT_ROOT = THIS_FILE.parents[2]          # data-pipeline
DAGS_SRC = PROJECT_ROOT / "dags" / "src"     # data-pipeline/dags/src
...
# -------------------------------------------------------------------
# Test 3: Financial profiles table structure
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Test 4: Reviews table structure + Foreign Key
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# Test 5: Model tablename correctness
# -------------------------------------------------------------------
